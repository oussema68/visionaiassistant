...
Responsibilities
Finding benefits: finding relatable benefits for the humans in health and well-being (if there's any. if not then dont bother doing this one and move to the next step).
